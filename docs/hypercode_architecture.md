...
- Neurodiversity guidelines: Progressive disclosure, predictability, minimal sensory load
...
**Language:** Python (POC), TypeScript (UI), WebAssembly (execution)
**AI Integration:** Anthropic Claude API, OpenAI GPT-4, Local Ollama
**Frontend:** React + Accessible Components + WCAG AAA
**Backend:** FastAPI, PostgreSQL, Redis
**DevOps:** GitHub Actions, Docker, Kubernetes
**Testing:** Pytest, Playwright, accessibility testing
