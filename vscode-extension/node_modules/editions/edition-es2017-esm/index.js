...
import { detailedError } from './util.js';
/**
 ...
 * @throws if invalid
 */
export function assertEdition(edition) {
    if (!edition ||
 ...
 */
export function assertEditions(editions) {
    ...
    if (failure) {
        ...
        if (broadenRange == null)
            try {
                ...
                const broadenedEdition = determineEdition(editions, Object.assign(Object.assign({}, opts), { broadenRange: true }));
                return Object.assign(Object.assign({}, broadenedEdition), {
