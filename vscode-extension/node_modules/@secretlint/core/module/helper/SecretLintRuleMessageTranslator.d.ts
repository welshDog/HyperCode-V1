...
}) => <MessageId extends keyof T, Props extends SecretLintRuleLocalizeMessageProps = T[MessageId]>(messageId: MessageId, props?: Props) => SecretLintRuleMessageTranslateResult<Props>;
