 ...
 */
export declare function isText(filename?: string | null, buffer?: Buffer | null): boolean | null;
/**
 ...
 * @returns Will be `null` if neither `filename` nor `buffer` were provided. Otherwise will be a boolean value with the detection result.
 */
export declare function isBinary(filename?: string | null, buffer?: Buffer | null): boolean | null;
/**
