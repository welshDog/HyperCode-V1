...
class ProjectConfig:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'ProjectConfig':
        ...
        return cls(
            ...
            dependencies=[ProjectDependency.from_dict(dep) for dep in data.get('dependencies', [])],
            dev_dependencies=[ProjectDependency.from_dict(dep) for dep in data.get('dev_dependencies', [])],
