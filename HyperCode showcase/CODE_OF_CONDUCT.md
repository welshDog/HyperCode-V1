...
- **Be Respectful**: Treat all people with kindness and dignity
- **Be Inclusive**: Welcome people of all backgrounds and perspectives
- **Be Patient**: Understand that learning takes time, and people have different paces
- **Be Constructive**: Offer feedback that builds up rather than tears down
- **Be Collaborative**: Work together toward HyperCode's shared vision
- **Listen Actively**: Try to understand others' viewpoints before responding
- **Assume Good Intent**: Give people the benefit of the doubt
- **Ask Questions**: When unsure, ask rather than assume
- **Celebrate Diversity**: Recognize that different thinking styles make us stronger
- **Take Breaks**: Mental health matters—step back when you need to
...
- Discrimination based on any identity or characteristic
...
- Creating fake accounts to evade bans
...
## ✋ What To Do If You Experience or Witness Violations

### For Direct Harassment or Harm

1. **You are not obligated to respond** to harassment. Your safety comes first.
2. **Document the behavior** if it's safe to do so (screenshots, links, timestamps)
3. **Report to moderators immediately** using the report mechanisms below
4. **Seek support** from trusted community members or external resources if needed
...
- **Who**: Names/usernames involved
- **What**: Description of the violation
- **When**: Date and time
- **Where**: Link to the specific content or space
- **Evidence**: Screenshots, links, or quotes (if safe)
- **Impact**: How this affected you or others
- **Desired Outcome**: What would help repair the harm?
...
3. **Interview relevant parties** (if safe and possible)
4. **Determine responsibility** with nuance and care
...
- Mediation if both parties consent
...
The following result in immediate investigation and likely removal:

- Threats of violence or harm
- Sexual harassment or unwanted advances
- Hate speech targeting protected groups
- Harassment of someone for their identity
- Intentional doxxing or publishing private information
- Creating an unsafe environment through repeated violations
...
- **Ask a moderator** before posting
- **Check past discussions** for similar topics
- **Start a private discussion** if you're uncomfortable asking publicly
- **No question is too small** — clarity helps everyone

---

## 🌍 Community Norms

Beyond this Code of Conduct, we strive for:

- **Radical Honesty**: We tell the truth about our limitations and progress
- **Radical Openness**: Decisions are transparent; criticism is welcome
- **Radical Kindness**: We assume good intent and assume others are doing their best
- **Radical Inclusion**: Everyone has a voice; no hierarchy of intelligence or worth
- **Radical Accountability**: We take responsibility for our actions and their impact

---

## 🔄 Community Feedback on This Document
...
**Changes to the Code of Conduct are decided by community vote among active members.**
...
- Real experiences of neurodivergent community members

---

## 📞 Contact

For CoC violations or concerns:
