...
- **Runtime**: Node.js 16+
- **Parser**: Custom lexer and AST-based parser
- **AI Integration**: REST/WebSocket APIs
- **Testing**: Jest
...
For now, clone the repo and follow [Getting Started guide](../docs/getting-started.md).
...
Currently, HyperCode is designed to be AI-compatible but integrations aren't live yet.
...
**Yes.** MIT license allows commercial use. No licensing fees.
...
### Where do I learn HyperCode?

1. **[Getting Started Guide](../docs/getting-started.md)** — Your entry point
...
- **Twitter** (coming soon)
- **Community Calls**: Monthly (starting Q1 2026)
...
### Why is HyperCode so slow?

Early releases prioritize correctness over performance. Optimization comes in Phase 2.
...
- **Visual Programming**: Scratch, Max/MSP
- **Neuroscience**: How different brains think
- **Accessibility Research**: Design for disabilities
