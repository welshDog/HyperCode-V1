        ...
        "beginner": [
            {
                ...
                "description": (
                    "Extend @ (2D mode) to support Z-axis for 3D spatial thinking. "
            ...
            },
            {
                ...
                "description": (
                    "Map operations to RGB colors: Red=memory, Green=logic, Blue=I/O. "
                    "Visual programming."
                ),
            ...
            },
            {
                ...
                "description": (
                    "Add @ pattern: repeat character N times. "
                    "E.g., @5+ instead of +++++"
                ),
        ...
        "intermediate": [
            {
                ...
                "description": (
                    "Define reusable code blocks. E.g., :add[ ... ] then :add to call."
                ),
            ...
            },
            {
                ...
                "description": (
                    "Name memory cells. E.g., let x = 5 instead of tracking manually."
                ),
            ...
            },
            {
                ...
                "description": (
                    "Add Q1, Q2, etc. for quantum operations. Future-proof design."
                ),
        ...
        "advanced": [
            {
                ...
                "description": (
                    "Add A, T, G, C for DNA computing experiments. Novel territory."
                ),
            ...
            },
            {
                ...
                "description": (
                    "Enable code to rewrite itself safely. Include formal verification."
                ),
        ...
        "beginner": [
            {
                ...
                "description": (
                    "Browser-based editor: write HyperCode → compile → run "
                    "→ see output. Real-time."
                ),
            ...
            },
            {
                ...
                "description": (
                    "Syntax highlighting, real-time compilation, debugging. "
            ...
            },
            {
                ...
                "description": (
                    "Full HyperCode → Python compiler. "
                    "Enables Python ecosystem integration."
                ),
        ...
        "intermediate": [
            {
                ...
                "description": (
                    "Compile HyperCode to WASM. Deploy in browser. Super fast."
                ),
            ...
            },
            {
                ...
                "description": (
                    "Claude/GPT integration: describe goal → generates HyperCode. "
                    "Multi-model."
                ),
            ...
            },
            {
                ...
                "description": (
                    "Real-time shared editing, like Google Docs but for HyperCode."
                ),
        ...
        "advanced": [
            {
                ...
                "description": (
                    "Target Qiskit/Cirq. Compile HyperCode to quantum circuits."
                ),
            ...
            },
            {
                ...
                "description": (
                    "Output DNA sequences. Partner with bio labs. Ultimate frontier."
                ),
        ...
        "beginner": [
            {
                ...
                "description": (
                    "Monthly HyperCode challenges: build X, share code, vote on best. "
            ...
            },
            {
                ...
                "description": (
                    "Structured 4-week program: learn HyperCode, build projects, "
                    "mentorship included."
                ),
            ...
            },
            {
                ...
                "description": (
                    "Curated collection of 50+ example programs: "
                    "games, algorithms, tools."
                ),
        ...
        "intermediate": [
            {
                ...
                "description": (
                    "Speak at dev conferences about HyperCode. Build awareness, "
            ...
            },
            {
                ...
                "description": (
                    "Integrate HyperCode into CS curriculum. Academic validation."
                ),
            ...
            },
            {
                ...
                "description": (
                    "Annual HyperCode hackathon. Hack, learn, build community. "
                    "Remote or in-person."
                ),
        ...
        "advanced": [
            {
                ...
                "description": (
                    "Partner with tech companies for funding, resources, "
            ...
            },
            {
                ...
                "description": (
                    "Establish HyperCode Foundation to ensure long-term accessibility, "
                    "funding, governance."
                ),
        ...
        "beginner": [
            {
                ...
                "description": (
                    "Bundle dyslexia-friendly fonts (Open Dyslexic, Dyslexie, etc). "
                    "Customizable UI."
                ),
            ...
            },
            {
                ...
                "description": (
                    "Minimal UI, distraction-free editor, timer, break reminders, "
                    "gamification."
                ),
            ...
            },
            {
                ...
                "description": (
                    "Toggle animations off, adjust color intensity, remove flashing, "
                    "explicit errors."
                ),
        ...
        "intermediate": [
            {
                ...
                "description": (
                    "Full NVDA/JAWS testing, accessibility audit, remediation."
                ),
            ...
            },
            {
                ...
                "description": (
                    "Gradually reveal complexity, scaffolded learning, visual aids, "
                    "simplified defaults."
                ),
        ...
        "advanced": [
            {
                ...
                "description": (
                    "Partner with universities: study HyperCode's impact on "
            ...
            },
            {
                ...
                "description": (
                    "Train accessibility auditors, create certification, "
                    "ensure ongoing WCAG compliance."
                ),
                "impact": "Very High - Sustainability",
...
class HyperCodeIdeaGenerator:
    ...
    def get_ideas_by_category(
        self, category: str, level: Optional[str] = None
    ) -> List[Any]:
        """
    ...
    def get_top_ideas(
        ...
        top_ideas = sorted(
            all_ideas, key=lambda x: int(str(x.get("votes", 0))), reverse=True
        )
        return top_ideas[:limit]

    def vote_for_idea(self, idea_id: str) -> bool:
        """Vote for an idea."""
        for category in self.ideas:
            for level in self.ideas[category]:
                for idea in self.ideas[category][level]:
                    if idea["id"] == idea_id:
                        idea["votes"] = int(str(idea.get("votes", 0))) + 1
                        return True
        return False

    def get_trending_ideas(self) -> List[Any]:
        """Get trending ideas (high votes + recent activity)."""
        top_ideas = self.get_top_ideas(limit=5)
        return top_ideas

    def format_idea_card(self, idea: Dict[str, Any]) -> str:
        """
