"""Database configuration and models for HyperFocus (canonical DB helpers)."""
...
# Use the canonical Base/engine from database_utils to avoid split-brain.
from database_utils import Base, SessionLocal, engine
...
class Database:
    ...
    def __init__(self):
        # Reuse canonical engine/session; wrap with scoped_session for thread safety.
        self.engine = engine
