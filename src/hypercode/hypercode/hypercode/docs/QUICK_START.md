...
**Beginner Path:**
1. [Language Tutorial](TUTORIAL.md) - Learn syntax step-by-step
2. [Best Practices](BEST_PRACTICES.md) - Write clean HyperCode
3. [Recipes](RECIPES.md) - Copy-paste solutions

**Builder Path:**
1. [Architecture Overview](ARCHITECTURE.md) - How HyperCode works
2. [API Reference](API_REFERENCE.md) - Built-in functions
3. [Contributing Guide](../CONTRIBUTING.md) - Add features

**Power User Path:**
1. [AI Integration Guide](AI_INTEGRATION_GUIDE.md) - Supercharge with AI
...
- Check the [Syntax Cheatsheet](LANGUAGE_REFERENCE.md)
...
[Back to Main README](../README.md) | [Full Documentation](README.md) | [Contributing](../CONTRIBUTING.md)
