    ...
    queries = [
        {
            ...
            "query": (
                "What are the key principles of neurodivergent-first programming "
                "language design?"
            ),
            "context": "Focus on accessibility for ADHD, autism, and dyslexia",
        },
        {
            "title": "Multi-Backend Architecture",
            "query": (
                "How can a programming language support multiple AI backends "
                "simultaneously?"
            ),
        ...
        },
        {
            ...
            "query": (
                "What are the benefits of 2D spatial code execution like Befunge?"
            ),
            "context": "Focus on visual thinking and neurodivergent cognitive "
            "patterns",
        },
        {
            "title": "Living Documentation",
            "query": (
                "How can technical documentation be automated and kept " "up-to-date?"
            ),
