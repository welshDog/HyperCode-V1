            ...
            try:
                with open(pyproject_path, 'r') as f:
                    ...
                    if "dependencies = [" in content:
                        ...
                        analysis["issues"].append("Dependencies not properly defined in pyproject.toml")
                        analysis["recommendations"].append("Add explicit dependencies to pyproject.toml")
            except Exception as e:
                analysis["issues"].append(f"Error reading pyproject.toml: {e}")
        else:
            analysis["issues"].append("No pyproject.toml found")
            analysis["recommendations"].append("Create pyproject.toml with proper dependencies")
