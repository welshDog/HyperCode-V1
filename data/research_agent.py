...
from scripts.database_utils.models import (
    ResearchAgent, ResearchTask, ResearchPaper,
    KnowledgeNode, KnowledgeRelationship, ConflictRecord
)
...
class BaseResearchAgent(ABC):
    ...
    def __init__(self, agent_id: int, name: str, agent_type: AgentType, model: Optional[str] = None):
