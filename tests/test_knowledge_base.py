...
class TestKnowledgeBaseSearch:
    ...
    def test_search_ranking(self, knowledge_base, sample_documents):
        ...
        knowledge_base.search = Mock(
            return_value=sorted(
                sample_documents, key=lambda x: "neurodivergent" in x["content"], reverse=True
            )
        )
...
class TestIntegrationWithPerplexity:
    ...
    def test_enhanced_query_with_context(self, mock_perplexity_client, mock_knowledge_base):
    ...
    def test_fallback_to_perplexity_api(self, mock_perplexity_client, mock_knowledge_base):
